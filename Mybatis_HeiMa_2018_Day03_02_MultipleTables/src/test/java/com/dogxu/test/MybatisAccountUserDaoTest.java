...
public class MybatisAccountUserDaoTest {
    ...
    @Test
    public void TestSelectAllAccountUser() {
        //5.使用代理对象执行方法：
        List<AccountUserEntity> accountUserEntities = accountDao.selectAllAccountUser();
        accountUserEntities.forEach(System.err::println);
